...
description: Peer-reviewed publications and contributed talks, ordered from most to least recent.
permalink: /publications-talks/
---

<div class="research-section-divider research-section-divider--summary" aria-hidden="true" style="margin-bottom: 0.75rem;"></div>
...
<div class="talk-cards" role="list">
    <article class="talk-card" role="listitem">
        ...
        <p class="talk-card-venue">Spirit of Lyot 6<br>Pasadena, CA</p>
        <p class="talk-card-actions">
            <a class="talk-card-link" href="https://conference.ipac.caltech.edu/SpiritofLyot6/slides/monday_afternoon_finley%20-%20Claire%20Finley.pdf">Slides</a>
        </p>
    </article>
